...
var len__4829__auto___10256 = arguments.length;
var i__4830__auto___10257 = (0);
while(true){
if((i__4830__auto___10257 < len__4829__auto___10256)){
args__4835__auto__.push((arguments[i__4830__auto___10257]));

var G__10258 = (i__4830__auto___10257 + (1));
i__4830__auto___10257 = G__10258;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10253){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10254,G__10255,seq10253__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10259_SHARP_){
return (!((cljs.core.meta.call(null,p1__10259_SHARP_) == null)));
})))){
...
var map__10260 = opts;
var map__10260__$1 = cljs.core.__destructure_map.call(null,map__10260);
var markup_db = cljs.core.get.call(null,map__10260__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10261){var _e__9511__auto__ = e10261;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e10263){var _e__9511__auto__ = e10263;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__10265 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__10266 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__10266);

try{var map__10267 = opts;
var map__10267__$1 = cljs.core.__destructure_map.call(null,map__10267);
var markup_db = cljs.core.get.call(null,map__10267__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__10265);
}});
...
var temp__5751__auto___10271 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___10271)){
var managed_print_level_10272 = temp__5751__auto___10271;
var _STAR_print_level_STAR__orig_val__10269_10273 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10270_10274 = managed_print_level_10272;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10270_10274);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__10268_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10268_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10269_10273);
}} else {
job_fn.call(null);
}
