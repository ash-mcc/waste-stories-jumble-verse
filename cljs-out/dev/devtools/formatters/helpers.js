...
var G__10231 = devtools.prefs.pref.call(null,v);
v = G__10231;
continue;
} else {
return v;
...
}catch (e10232){var _e__9511__auto__ = e10232;
return false;
}})();
...
}catch (e10234){var _e__9511__auto__ = e10234;
return false;
}})();
...
}catch (e10236){var _e__9511__auto__ = e10236;
return false;
}}
}
});
...
var vec__10238 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10238,(0),null);
var name = cljs.core.nth.call(null,vec__10238,(1),null);
...
return cljs.core.some.call(null,(function (p1__10241_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10241_SHARP_);
}),template);
});
