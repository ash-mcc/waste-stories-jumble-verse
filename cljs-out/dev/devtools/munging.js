...
var o10127 = temp__5751__auto__;
var temp__5751__auto____$1 = (o10127["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o10128 = temp__5751__auto____$1;
return (o10128["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9504__auto__ = f;
return (o__9504__auto__["toString"]).call(o__9504__auto__);
} else {
return "";
}
}catch (e10129){var _ = e10129;
return "";
}});
...
try{var o__9504__auto___10131 = t;
(o__9504__auto___10131["cljs$lang$ctorPrWriter"]).call(o__9504__auto___10131,t,writer);
}catch (e10130){var __10132 = e10130;
}
...
var char_code = (function (){var o__9504__auto__ = (new String(char$));
return (o__9504__auto__["charCodeAt"]).call(o__9504__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9504__auto__ = String;
return (o__9504__auto__["fromCharCode"]).call(o__9504__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10133 = num_code;
switch (G__10133) {
case (1):
return (185);
...
var o__9504__auto__ = String;
return (o__9504__auto__["fromCharCode"]).call(o__9504__auto__,superscript_code);
});
/**
...
}catch (e10135){var _e__9511__auto__ = e10135;
return false;
}})())){
...
var vec__10136 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10136,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o10139 = temp__5751__auto__;
var temp__5751__auto____$1 = (o10139["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o10140 = temp__5751__auto____$1;
return (o10140["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4829__auto___10147 = arguments.length;
var i__4830__auto___10148 = (0);
while(true){
if((i__4830__auto___10148 < len__4829__auto___10147)){
args__4835__auto__.push((arguments[i__4830__auto___10148]));

var G__10149 = (i__4830__auto___10148 + (1));
i__4830__auto___10148 = G__10149;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10143){
var vec__10144 = p__10143;
var ns_detector = cljs.core.nth.call(null,vec__10144,(0),null);
...
var G__10150 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10151 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10150;
remaining_tokens = G__10151;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10141){
var G__10142 = cljs.core.first.call(null,seq10141);
var seq10141__$1 = cljs.core.next.call(null,seq10141);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10142,seq10141__$1);
}));
...
var vec__10155 = cljs.core.split_with.call(null,(function (p1__10154_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10154_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10155,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10155,(1),null);
...
var vec__10161 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10161,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10161,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10164 = cljs.core.rest.call(null,remaining_tokens);
var G__10165 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10164;
name_tokens = G__10165;
continue;
} else {
...
var vec__10168 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10168,(0),null);
var arity = cljs.core.nth.call(null,vec__10168,(1),null);
var vec__10171 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10171,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10171,(1),null);
var vec__10174 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10174,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10174,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10174,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10174,(3),null);
...
var vec__10180 = result;
var munged_ns = cljs.core.nth.call(null,vec__10180,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10180,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10180,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10180,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10180,(4),null);
var arity = cljs.core.nth.call(null,vec__10180,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__10184 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__10184,(0),null);
var args = cljs.core.nth.call(null,vec__10184,(1),null);
var vec__10187 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10187,(0),null);
var name = cljs.core.nth.call(null,vec__10187,(1),null);
...
var G__10190 = (arity + (1));
var G__10191 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10192){
var vec__10193 = p__10192;
var arity = cljs.core.nth.call(null,vec__10193,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10193,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10196_SHARP_){
return cljs.core.get.call(null,arities,p1__10196_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10197_SHARP_){
return cljs.core.drop.call(null,(2),p1__10197_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___10204 = arguments.length;
var i__4830__auto___10205 = (0);
while(true){
if((i__4830__auto___10205 < len__4829__auto___10204)){
args__4835__auto__.push((arguments[i__4830__auto___10205]));

var G__10206 = (i__4830__auto___10205 + (1));
i__4830__auto___10205 = G__10206;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10200){
var vec__10201 = p__10200;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10201,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10198){
var G__10199 = cljs.core.first.call(null,seq10198);
var seq10198__$1 = cljs.core.next.call(null,seq10198);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10199,seq10198__$1);
}));
...
var map__10209 = options;
var map__10209__$1 = cljs.core.__destructure_map.call(null,map__10209);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10209__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10209__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10209__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10209__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10210 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10210,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10210,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10210,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10210,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10210,(4),null);
var arity = cljs.core.nth.call(null,vec__10210,(5),null);
...
var o__9504__auto__ = f;
return (o__9504__auto__["getBasis"]).call(o__9504__auto__);
});
/**
...
}catch (e10213){var _e__9511__auto__ = e10213;
...
var G__10214 = (obj[cljs.core.first.call(null,path)]);
var G__10215 = cljs.core.rest.call(null,path);
obj = G__10214;
path = G__10215;
continue;
} else {
...
var _STAR_ = (function (accum,p__10216){
var vec__10217 = p__10216;
var bit = cljs.core.nth.call(null,vec__10217,(0),null);
var protocol = cljs.core.nth.call(null,vec__10217,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10220){
var vec__10221 = p__10220;
var ns = cljs.core.nth.call(null,vec__10221,(0),null);
var name = cljs.core.nth.call(null,vec__10221,(1),null);
var selector = cljs.core.nth.call(null,vec__10221,(2),null);
...
var post_process = (function (p__10225){
var vec__10226 = p__10225;
var munged_name = cljs.core.nth.call(null,vec__10226,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10226,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10224_SHARP_){
return (obj[cljs.core.first.call(null,p1__10224_SHARP_)]);
}),sorted_matches);
