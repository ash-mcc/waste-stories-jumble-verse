...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__12135_SHARP_){
return parseInt(p1__12135_SHARP_);
}),cljs.core.take.call(null,(3),clojure.string.split.call(null,v,/[^\d]/)))));
}catch (e12136){if((e12136 instanceof Error)){
var e = e12136;
...
var c_12138 = (new goog.debug.Console());
var G__12137_12139 = c_12138.getFormatter();
goog.object.set(G__12137_12139,"showAbsoluteTime",false);

goog.object.set(G__12137_12139,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_12138);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__12140_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__12140_SHARP_);
